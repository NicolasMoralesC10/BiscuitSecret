...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ url('users')}}">Usuarios</a></li>
            @endif
            @if (str_contains(Request::path(), 'users'))
                @if (str_contains(Request::path(), 'create'))
                    <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">Nuevo Usuario</li>
                @elseif (str_contains(Request::path(), 'edit'))
                    <li class="breadcrumb-item text-sm text-dark active text-capitalize" aria-current="page">Editar Usuario</li>
                @else
           ...
           <!--  <h6 class="font-weight-bolder mb-0 text-capitalize">
                @if (str_contains (Request::path(), 'ventas/create'))
