...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg bg-white" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Route::currentRouteName() == 'ventas.index' || 
                Route::currentRouteName() == 'ventas.create' || 
                Route::currentRouteName() == 'ventas.edit' || 
                Route::currentRouteName() == 'ventas.show' ? 'active' : '') }}" href="{{ url('ventas') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Route::currentRouteName() == 'ventas.index' || 
                Route::currentRouteName() == 'ventas.create' || 
                Route::currentRouteName() == 'ventas.edit' || 
                Route::currentRouteName() == 'ventas.show' ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
