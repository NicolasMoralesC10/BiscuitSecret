    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('ventas') || Request::is('ventas/create') ? 'active' : '') }}" href="{{ url('ventas') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('ventas') || Request::is('ventas/create') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
