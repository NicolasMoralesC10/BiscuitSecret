<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg bg-white" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('productos') || Request::is('productos/create') ? 'active' : '') }}" href="{{ url('productos') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fa-solid fa-boxes-stacked ps-2 pe-2 text-center text-dark {{ (Request::is('productos') || Request::is('productos/create') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
